...
int main(void)
{
    ...
    const char *ppm = "newtonian_black_hole_point_source_rk.ppm";
...
#ifdef _OPENMP
    nbh_prun(nbh_gravity, nbh_stop, nbh_bright_checker_board, nbh_rk_path, ppm);
#else
    nbh_run(nbh_gravity, nbh_stop, nbh_bright_checker_board, nbh_rk_path, ppm);
#endif
    return 0;
}
/*  End of main.                                                              */
